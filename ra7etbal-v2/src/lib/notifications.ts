...
const FIELDS = "id,user_id,event_key,kind,title,body,occurred_at,read_at,dismissed_at,target_type,target_id,target_url,metadata,created_at";
...
export async function dismissOwnerNotification(id: string, dismissedAt: string): Promise<void> {
