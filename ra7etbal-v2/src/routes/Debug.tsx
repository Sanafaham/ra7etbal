  ...
  return (
    <section className="space-y-5 rounded-2xl border border-sage/30 bg-white/80 p-6 shadow-sm">
      ...
      <p className="text-xs text-ink/60">
        Step 2 verification page. Status should settle on <code>signed_out</code> within
        a few hundred ms of first load (you'll see <code>loading</code> → INITIAL_SESSION
        in the event log). No app screens are wired yet.
      </p>
    </section>
  );
}
