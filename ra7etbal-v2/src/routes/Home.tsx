    ...
    >
      ...
      <section data-testid="home-talk-to-carson-section" className="mt-6 sm:mt-8">
        <button
          ...
          className="group flex w-full flex-col items-center gap-1 rounded-[28px] bg-warm-white px-6 py-3 shadow-[0_24px_60px_-30px_rgba(20,20,20,0.28)] backdrop-blur-sm transition active:scale-[0.982]"
        >
